//
//  BaseDismissablePopupViewController.swift
...
class BaseDismissablePopupViewController : BaseUIViewController{
    override func viewDidLoad() {
        super.viewDidLoad()
        
        view.backgroundColor = UIColor.transparant_50()
    }
}


extension BaseDismissablePopupViewController{
